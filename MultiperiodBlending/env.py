...
class BlendEnv_Omni(CMDP):
    ...
    def __init__(self, env_id, **kwargs):
        ...
        self.env_spec_log = {"Penalties/M": 0, "Penalties/B": 0, "Penalties/P": 0, "Penalties/Q": 0, 
                            ...
                            "Performances/units_sold": 0, "Performances/units_bought": 0, "Performances/rew_sold": 0, "Performances/rew_depth": 0, "Performances/rew_bought": 0,
                            }
    ...
    def step(self, action: th.Tensor):
        ...
        return th.tensor(self.flatt_state).to("cuda:0"), th.tensor(reward).to("cuda:0"), cost_tensor.sum().to("cuda:0"), th.tensor(self.terminated).to("cuda:0"), \
...
if __name__ == "__main__":
    ...
    layout = "simple"
    ALGO = "CPO"
    cfg = cfg_to_omni(cfg_id=77, layout=layout, total_steps=3e5, algo=ALGO)
