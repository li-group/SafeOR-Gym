...
from gen_exp_gym import Generator_expansion_env
@env_register
class Generator_expansion_env_safe(CMDP):
    ...
    def __init__(self, env_id: str,
        ...
        self._env = Generator_expansion_env(env_id=env_id, **kwargs.get('env_init_cfgs', {}))
...
if __name__ == '__main__':
    eg = ExperimentGrid(exp_name='Benchmark_Safety_simple_6')
    ...
    'T': 5,
    'gencap': {"i1": 10,"i2":5},
    'maxgen': {"i1":{ "r1": 3,"r2":3},"i2":{ "r1": 3,"r2":3}},
    'installcost': {"generators": {"i1": 10,"i2":6}},
    'demand': {"r1":{"1": 5,"2":10,"3":10,"4":20,"5":30},"r2":{"1": 5,"2":5,"3":15,"4":25,"5":35}}}}
    '''env_config = {'env_init_cfgs':{
    'T': 1,
    'gencap': {"i1": 10},
    'maxgen': {"i1":{ "r1": 1,"r2":1}},
